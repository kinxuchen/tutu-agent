...
clientele_templates = """
    ...
    3. 用户可能会将人名或者机构名称，通过空格或者标点符号进行分隔，请在解析的时候注意用户的输入格式
    4. 你需要剔除那些非人名或者机构名称的信息
    示例:
    - 输入: 张三 然后查询复合细水豆沙灰、咖啡各4米（现货45/米）
    - 输出: 张三
    - 输入: 新希望张总，然后查询复合细水豆沙灰、咖啡各4米（现货45/米）
    - 输出: 新希望张总
    - 输入: 查询复合细水豆沙灰、咖啡各4米（现货45/米）永和刘总
    - 输出: 刘总
"""
